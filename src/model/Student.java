...
public class Student extends User {
    ...
    private final StringProperty studentNum;
    
    Student(String firstName, String lastName, String userName, String password, String studentNum) {
    ...
    public StringProperty getStudentName(){
        StringProperty result = new SimpleStringProperty(getFirstName() + " " + getLastName());
        return result;
    }
     ...
     */
    public void studentNum(String studentNum) {
        this.studentNum.set(studentNum);
    }
    
    public StringProperty studentNum(){
        return studentNum;
    }
}
