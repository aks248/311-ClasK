...
public class SerializedCollection {
    ...
    public void createCourseList(){
        mainInstance.getListOfCourses().add(new Course("IST311", "3", "room3"));
    ...
    public void addToListOfCourses(String crsName, String roomNum, String password){
        mainInstance.getListOfCourses().add(new Course(crsName, roomNum, password));
        //System.out.println("Testing");
        for(int i = 0; i < mainInstance.getListOfCourses().size(); i++){
            Course curCourse = (Course) mainInstance.getListOfCourses().get(i);
            //System.out.println(curCourse.getCourseName());
