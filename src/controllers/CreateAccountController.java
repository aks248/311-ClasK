...
public class CreateAccountController {
    ...
    public boolean validateAccount() {
        ...
        if (getUsername().length() == 0 || getUsername().equals("")) {
            ...
            flag = true;
        } else if (UserDatabase.containsUser(getUsername())) {
    ...
    public void createUser() {
        if ((validateAccount()) && (getUsrType().equals("Student"))) {
            //System.out.println("********************");
           // System.out.println(getfName() +" " + getlName()+ " "+ getUsername()+" "+ getPassword());
            getSerialized().addToListOfStudents(getfName(), getlName(), getUsername(), getPassword(),"");
            //System.out.println(getMainInstance().getListOfStudents().get(0).getStudentName());
            try {
        ...
        getSerialized().readUserListFile();
